...
trainer_stats_name="timing_bkwd"
...
class ResourceStats(base.TrainerStats):
    ...
    def __init__(self, device: torch.device, conf: config.Config):
        ...
        # data for backward stage
        self.bkwd_data = stats.TimingStatsData(conf)
    ...
    def log_stats(self):
        self.bkwd_data.to_csv(exp="time", dir="timing_data", step="backward")
